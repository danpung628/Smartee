    ...
    Column {
        ...
        ExposedDropdownMenuBox(
            ...
            TextField(
                ...
                readOnly = true,
                label = { Text("시/도 선택") },
                trailingIcon = { ExposedDropdownMenuDefaults.TrailingIcon(expanded = sidoExpanded) },
        ...
        ExposedDropdownMenuBox(
            ...
            TextField(
                ...
                readOnly = true,
                label = { Text("시/군/구 선택") },
                trailingIcon = { ExposedDropdownMenuDefaults.TrailingIcon(expanded = sigunguExpanded) },
                modifier = Modifier.menuAnchor().fillMaxWidth()
            )
            ExposedDropdownMenu(
                expanded = sigunguExpanded,
